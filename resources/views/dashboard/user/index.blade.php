        ...
        <div class="card">
            <div class="card-body">
                {!! Form::open([
                    'method' => 'get',
                    'autocomplete' => false,
                    'route' => ['dashboard.user.index', http_build_query(Request::input())],
                        ...
                        <tbody>
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>{!! $item->is_manager == 1 ? 'Sim' : 'Não' !!}</td>
                                    <td><a href="{!! route('dashboard.user.show', $item->id) !!}" class="btn btn-warning"><i
                                                class="bi bi-pencil-square"></i></a></td>
                                    <td><a href="{!! route('dashboard.user.delete', $item->id) !!}" class="btn btn-danger btn-delete"><i
