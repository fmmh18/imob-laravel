            ...
            <div class="card-body">
                @if (isset($data))
                    {!! Form::model($data, [
                        'method' => 'put',
                        'autocomplete' => false,
                        'route' => ['dashboard.type.update', $data->id, http_build_query(Request::input())],
                ...
                @else
                    {!! Form::open([
                        'method' => 'post',
                        'autocomplete' => false,
                        'route' => ['dashboard.type.create', http_build_query(Request::input())],
                        'class' => $errors->any() ? 'was-validated' : '',
                        'novalidate',
                        'files' => true,
                    ]) !!}
                ...
                <div class="row">
                    <div class="col-12 text-end pt-3">
                        <a href="{!! route('dashboard.type.index') !!}" class="btn btn-secondary rounded-0">Voltar</a>
