        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 text-end pt-3">
                    ...
                    <a href="{!! route('dashboard.state.index') !!}" class="btn btn-secondary rounded-0">Limpar</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
                        ...
                        <tbody>
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td>{!! $item->name !!}</td>
                                    <td>{!! $item->initials !!}</td>
                                    {{-- <td><a href="{!! route('dashboard.state.show', $item->id) !!}" class="btn btn-warning"><i
                                                class="bi bi-pencil-square"></i></a></td>
                                    <td><a href="{!! route('dashboard.state.delete', $item->id) !!}" class="btn btn-danger btn-delete"><i
