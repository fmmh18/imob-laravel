...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/logo/logo_white.png') }}">
...
<body>
    ...
    @php
        ...
        $text .= 'Ola,' . env('APP_NAME') . ', vim pelo botão de whatsapp, gostaria de mais informações.';
    @endphp

    <div class="floating-buttons">
        <a href="https://api.whatsapp.com/send?phone=55{!! sanitizeString($config->phone) ?? '65987654321' !!}&text={!! $text !!}"
